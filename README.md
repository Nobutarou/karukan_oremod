...
- l で確定
  - アルファベットを打とうとして頻繁に叩いてしまう。
  - 確定してアルファベットモードに入ることも考えたけど、fcitx5 は、英数字は im を通さない
    方が Librecad とかでのショートカットで問題が起きにくいため、アルファベットモードを使わ
    ない作戦を取ることにしてみる
  - いろんなとこの IM を使うことを考えると、英数キーに慣れるべき。
- ctrl-j で確定
...
- shift de kakutei sitakatta kedo muri datta.
- 基本半角スペースを入れたい。
